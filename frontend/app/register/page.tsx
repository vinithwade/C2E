...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorMessage = 
        ...
        err.message || 
        (err.code === 'ECONNREFUSED' ? 'Cannot connect to server. Please make sure the backend is running.' : 'Registration failed. Please try again.');
  ...
  return (
    <div className={styles.registerPage}>
      ...
      <section className={styles.registerCarousel}>
      ...
      <div className={styles.registerFormSection}>
        <div className={styles.registerHeader}>
          <h1 className={styles.registerTitleWrapper}>
            <span className={styles.registerTitleMobile}>Welcome to </span>
            <Link href="/" className={styles.registerLogoText}>C2E</Link>
          </h1>
          <h1 className={styles.registerSubtitle}>The unified video collaboration API for creators and editors.</h1>
        </div>
        ...
        <form className={styles.registerForm} onSubmit={handleSubmit}>
          ...
          <div className={styles.formGroup}>
            <p className={styles.formLabel}>Name (optional)</p>
            <input
          ...
          <div className={styles.formGroup}>
            <button className={styles.btnSubmit} type="submit" disabled={isLoading}>
              {isLoading ? 'Creating account...' : 'Sign up to C2E'}
          </button>
          </div>
        </form>
        ...
        <div className={styles.socialButtons}>
          <button className={styles.btnSocial} type="button" onClick={handleGoogleSignup}>
          ...
          <button className={styles.btnSocial} type="button" onClick={handleGithubSignup}>
            <span className={styles.btnSocialIcon}>
        ...
        <p className={styles.registerFooter}>
          ...
          <span className="inline-block">
            <a href="#">Terms</a> and <a href="#">Privacy Policy</a>.
               ...
               <p className={styles.registerFooter} style={{ marginTop: '1rem' }}>
                 Already have an account?{' '}
                 <Link href="/login" style={{ color: '#0066FF', textDecoration: 'underline' }}>
            Log in
                 </Link>
        </p>
      </div>
